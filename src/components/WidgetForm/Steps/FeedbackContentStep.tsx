    ...
    <>
      ...
      <form className="my-4 w-full">
        ...
        <footer className="flex gap-2 mt-2">
          ...
          <button
            type="submit"
            className="p-2 text-zinc-300 hover:text-zinc-100  bg-brand-500 rounded-sm border-transparent flex-1 flex justify-center items-center text-sm hover:bg-brand-300 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-zinc-900 focus:ring-brand-500 transition-colors"
          >
            Enviar feedback
          </button>
        </footer>
